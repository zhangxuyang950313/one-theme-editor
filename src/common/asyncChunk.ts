...
import type { fileDataWithCache } from "main/singletons/fileCache";
...
export async function chunkFileCache(): Promise<typeof fileDataWithCache> {
  return (await import("main/singletons/fileCache")).fileDataWithCache;
}
