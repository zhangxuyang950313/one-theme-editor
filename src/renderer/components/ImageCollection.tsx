 ...
 */
export const PreloadImage = forwardRef<HTMLImageElement, TypeReactImageElement>(function PreloadImage(props, ref) {
 ...
 * @returns
 */
export const LazyImage = forwardRef<HTMLImageElement, TypeReactImageElement>(function LazyImage(props, ref) {
